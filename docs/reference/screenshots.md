...
![Mermaid 增强效果](../assets/images/5.png)

<details>
<summary>查看原版效果 (点击展开)</summary>

![Mermaid 原版效果](../assets/images/6.png)

</details>

## 数学公式渲染

原版只能显示 LaTeX 源码, 补丁启用后渲染为数学公式.

![公式增强效果](../assets/images/3.png)

<details>
<summary>查看原版效果 (点击展开)</summary>

![公式原版效果](../assets/images/4.png)
...
![复制按钮展示](../assets/images/2.png)

复制后的内容会转换为规范的 Markdown 格式.

![复制内容展示](../assets/images/1.png)
