...
<p align="center">
  <a href="https://github.com/Huo-zai-feng-lang-li/Antigravity-Power-Pro/releases">
    <img src="https://img.shields.io/badge/version-v2.6.41-gold?style=flat-square" alt="版本">
...
| :---------- | :----------------- | :--------- | :--------------------------------------------------------------------------------------------------- |
| **v2.6.41** | v1.23.2 / Windsurf | 2026-05-14 | **优化**: 交互动效分级(Hover仅旋转, Click发光), 按钮位置强制归一化 |
