...
<p align="center">
  <a href="https://github.com/Huo-zai-feng-lang-li/Antigravity-Power-Pro/releases">
    <img src="https://img.shields.io/badge/version-v2.6.61-gold?style=flat-square" alt="版本">
...
| :---------- | :----------------- | :--------- | :--------------------------------------------------------------------------------------------------- |
| **v2.6.61** | v1.23.2 / Windsurf | 2026-05-15 | **根治**: Manager 滚动按钮终极修复，移除对不存在的语义类名依赖，改为 Tailwind 工具类无关策略 | ✅ 推荐 |
