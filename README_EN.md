...
<p align="center">
  <a href="https://github.com/Huo-zai-feng-lang-li/Antigravity-Power-Pro/releases">
    <img src="https://img.shields.io/badge/Version-v2.6.57-gold.svg?style=flat-square" alt="Version">
  </a>
...
| ------------- | ----------------------------- | ---------- | ---------------------------------------------------------------------------------- |
| v2.6.57       | v1.23.2 / Windsurf            | 2026-05-15 | **Ultimate Fix**: Native DOM inject via Range Selection targeting old text completely bypassing React append loop |
